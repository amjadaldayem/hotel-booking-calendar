<template>
  <div
    ref="target"
    v-if="showPopup"
    class="mx-1/2 absolute bottom-0 left-0 top-1/4 mt-9 flex h-min flex-col gap-2 rounded-lg border border-table-border-light bg-base-white p-4 text-left text-base-black shadow ring-0 dark:border-table-border-dark dark:bg-base-black dark:text-base-white"
